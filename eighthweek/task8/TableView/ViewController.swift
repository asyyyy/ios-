...
class ViewController: UIViewController,UITableViewDataSource,UITableViewDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        let t1 = Teacher(firstName: "ruili", lastName: "Li", age:19, gender: Gender.male, title: "professor")
        let t2 = Teacher(firstName: "ruili", lastName: "Huang", age: 19, gender: Gender.female, title: "lecturer")
        let s1 = Student(firstName: "Baicheng", lastName: "Xu", age: 20, gender: Gender.male, stuNo: "2016110332")
        let s2 = Student(firstName: "cherry", lastName: "Wang", age: 21, gender: Gender.male, stuNo: "2016110333")
        let s3 = Student(firstName: "lili", lastName: "Zhang", age: 20, gender: Gender.female, stuNo: "2016110334")
